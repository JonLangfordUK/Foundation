...
- `2026-07-15`: User reported a Bevy B0001 panic after the console input/action change. Fixed conflicting mutable `Text` queries in the console text refresh system by using a `ParamSet` for output and suggestion text queries.
