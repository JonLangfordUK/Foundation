...
- Run `scripts/format-project.cmd`, `scripts/lint-project.cmd`, `scripts/test-project.cmd`, `scripts/compile-project.cmd`, and `scripts/doc-project.cmd` unless the user says not to or the tracker records an approved waiver.
