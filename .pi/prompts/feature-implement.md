...
- Run `scripts/format-project.cmd`, `scripts/lint-project.cmd`, `scripts/test-project.cmd`, and `scripts/compile-project.cmd` unless the user says not to or the tracker records an approved waiver.
...
- Do not mark tasks or phases complete until the tracker skill validation rules are satisfied.
